        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-address-book"></i> Novo Cliente
                    <a href='<?= base_url()?>cliente/' class="btn btn-custom pull-right waves-effect waves-light"><i class="fa fa-chevron-left"></i> Listar cliente</a></h3>
            </div>
            <hr class="divisor"><br>
            <form action="<?= base_url()?>gravar-cliente" method="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <label for="">Logo Do Cliente</label>
                    <div class="card-box widget-box-three">
                        ...
                        <div class="text-center">
                            ...
                            <input type="file" class="filestyle" data-input="false" tabindex="-1" data-buttontext="Imagem" name="cliente_img" style="position: absolute; clip: rect(0px 0px 0px 0px);" required>
                        </div>
                    </div>
                </div>
                <div class="row"></div><br><br>
