...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-handshake-o"></i> Clientes
                    <a href='<?= base_url()?>novo-cliente' class="btn btn-custom pull-right waves-effect waves-light"><i class="fa fa-user-plus"></i> Adicionar Novo</a></h3>
            </div>
            <hr class="divisor">
            <br>
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                <?php foreach($cliente as $s): ?>
                    <tr id="registro_tr_<?= $s['cliente_id']?>">
                        <td class="text-center hide">#<?= $s['cliente_id']?></td>
                        <td class="text-center"><?= $s['cliente_nome']?></td>
                        <td class="text-center">
                            <a href="<?= base_url()?>editar-cliente/<?=$s['cliente_id']?>" class="btn btn-custom btn-rounded waves-effect waves-light"><i class="fa fa-edit"></i></a>
                            <a class="btn btn-danger btn-rounded btn-small waves-effect waves-light remove-registro" data-toggle="modal" data-target=".modal-remove" data-id="<?=$s['cliente_id']?>"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
...
<script src="<?= base_url('app-js/admin/cliente.js')?>"></script>
<script>
    $('#datatable').DataTable({
        "language": {
